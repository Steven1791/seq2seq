...
parser.add_argument('--split_length', default=40, help="Set 'split_length' to number of seconds.)")
...
t1 = 0
tdelta = args.split_length * 1000 # 1000 equals 1sec
t2 = tdelta
i = 0
...
def save_wav(newAudio, t1,t2,i,path):
	...
	wavpath = path + str(i) + ".wav"  # defining wavpath incl. enumerator
	newAudio_seg.export(wavpath, format="wav")  # saving newAudio2 wav object at wavpath
